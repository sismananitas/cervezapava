...
<head>
	<title>Pava &#8211; Cerveza Artesanal</title>
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
	<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
	<link rel="icon" href="images/pava/logo.png" type="image/x-icon">
		...
		<div class="page_wrap">
			...
			<div class="menu_side_wrap scheme_dark">
				<div class="menu_side_inner">
					<a class="menu_mobile_button menu_mobile_button_text">ME NU</a>
				</div>
			</div>
				...
				<div class="menu_mobile_inner">
					...
					<nav class="menu_mobile_nav_area">
						<ul id="menu_mobile" class="menu_mobile_nav">
							<li class="menu-item">
								<a href="#sc_anchor_inicio"><span>Inicio</span></a>
							</li>
							<li class="menu-item">
								<a href="#sc_anchor_origen"><span>Origen</span></a>
							</li>
							<li class="menu-item">
								<a href="#sc_anchor_caracteristicas"><span>Características</span></a>
							</li>
							<li class="menu-item">
								<a href="#sc_anchor_contacto"><span>Contacto</span></a>
							</li>
						</ul>
					</nav>
					<div class="socials_mobile"><span class="social_item"><a href="#" target="_blank" class="social_icons instagram"><span class="trx_addons_icon-instagram"></span></a>
					...
					<div class="content">
						<article id="post-691" class="post_item_single post_type_page post-691 page type-page">
							<div class="post_content entry-content">
								...
								<a id="sc_anchor_inicio" class="sc_anchor" title="Inicio" data-icon="" data-url=""></a>
								<!-- START Slider Pava REVOLUTION SLIDER 6.4.6 --><p class="rs-p-wp-fix"></p>
			<rs-module-wrap id="rev_slider_24_1_wrapper" data-alias="slider-pava" data-source="gallery" style="background:transparent;padding:0;">
				<rs-module id="rev_slider_24_1" style="" data-version="6.4.6">
					<rs-slides>
						<rs-slide data-key="rs-109" data-title="Slide" data-in="o:0;" data-out="a:false;">
							<img src="assets/bg_1.png" title="bg_1" width="1920" height="1080" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
							--><rs-layer
								id="slider-24-slide-109-layer-0" 
								data-type="image"
								data-rsp_ch="on"
								data-xy="x:c;yo:43px,43px,45px,62px;"
								data-text="w:normal;s:20,20,12,7;l:0,0,15,9;"
								data-dim="w:166px,166px,151px,106px;h:166px,166px,151px,106px;"
								data-frame_0="sX:0.9;sY:0.9;"
								data-frame_1="e:power2.inOut;sp:1000;"
								data-frame_999="o:0;st:w;sR:8000;"
								style="z-index:5;"
							><img src="assets/logo_banner_landing_pava.png" class="tp-rs-img" width="166" height="166" data-no-retina> 
							</rs-layer><!--
							...
							--><rs-layer
								...
								data-xy="x:c;y:m;"
								data-text="w:normal;s:20,20,12,7;l:0,0,15,9;"
								data-dim="w:654px,654px,465px,330px;h:277px,277px,197px,140px;"
								data-frame_0="sX:0.9;sY:0.9;"
								data-frame_1="e:power2.inOut;st:300;sp:1000;sR:300;"
								data-frame_999="o:0;st:w;sR:7700;"
								style="z-index:6;"
							><img src="assets/texto-central_banner_landing_pava.png" class="tp-rs-img" width="654" height="277" data-no-retina> 
							</rs-layer><!--
-->						</rs-slide>
					</rs-slides>
				</rs-module>
			...
			<!-- END REVOLUTION SLIDER -->
								...
								<div id="fondoos" class="row row-no-padding vc_custom_1466087475749 row-o-full-height row-o-columns-stretch row-o-equal-height">
									<div class="wpb_column vc_column_container column-12_12">
										<div class="vc_column-inner ">
											<div class="wpb_wrapper">
												<a id="sc_anchor_origen" class="sc_anchor" title="Origen" data-icon="" data-url=""></a>
												<div class="sc_promo sc_promo_default sc_promo_size_large">
													<div class="sc_promo_image" style="background-image:url(images/pava/origen.png);width:100%;left: 0;"></div>
													<div class="sc_promo_text trx_addons_stretch_height" style="width: 50%;float: right;">
														<div class="sc_promo_text_inner sc_align_center" style="color: white !important;">
															<!-- <div class="sc_promo_icon" data-icon="icon-grape-3"><span class="icon-grape-3"></span></div> -->
															<h2 class="sc_item_title sc_promo_title" style="color: white !important;">Origen</h2>
															<h5 class="sc_item_subtitle sc_promo_subtitle" style="color: white !important;">Lovely Relaxed Atmosphere of the Winery Gives You a Positive.</h5>
															<div class="sc_item_descr sc_promo_descr">Cras sodales luctus arcu, ac placerat nunc sagittis a. In at turpis ac nibh luctus sagittis in ut est. Proin sed mi vitae velit convallis gravida imperdiet eu mauris. Maecenas vehicula quam vel urna pulvinar, quis faucibus quam pellentesque.
																Sed vitae pellentesque velit. Etiam nec ornare tortor.</div>
															<div class="sc_promo_content sc_item_content">
																<div class="wpb_single_image wpb_content_element vc_align_center">
																	<figure class="wpb_wrapper vc_figure">
																		<!-- <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="297" height="105" src="images/sinature.png" class="vc_single_image-img attachment-full" alt="sinature" /></div> -->
																	</figure>
																</div>
															</div>
								...
								<div id="fondoos2" class="row row-no-padding row-o-full-height row-o-columns-stretch row-o-equal-height">
									<div class="wpb_column vc_column_container column-12_12 vc_col-has-fill">
										<div class="vc_column-inner vc_custom_1465806595697">
											<div class="wpb_wrapper">
												<a id="sc_anchor_caracteristicas" class="sc_anchor" title="Cracterísticas" data-icon="" data-url=""></a>
												<div class="sc_promo sc_promo_default sc_promo_size_large" style="color: black !important;">
													<div class="sc_promo_image" style="background-image:url(images/pava/caracteristicas.png);width:100%;right: 0;"></div>
													<div class="sc_promo_text trx_addons_stretch_height" style="width: 50%;float: left;">
														<div class="sc_promo_text_inner sc_align_center">
															...
															<h2 class="sc_item_title sc_promo_title" id="blancotext1">Características</h2>
															<h5 class="sc_item_subtitle sc_promo_subtitle" id="blancotext2">We make wine with a thought of our customers, therefore the team...</h5>
															<div class="sc_item_descr sc_promo_descr" id="blancotext3">Pressing is the act of applying pressure to grapes or pomace in order to separate juice or wine from grapes and grape skins. Pressing is not always a necessary act in winemaking; if grapes are crushed there is a considerable amount of juice
																immediately liberated (called free-run juice) that can be used for vinification. Typically this free-run juice is of a higher quality than the press juice.</div>
					...
					<div class="row vc_custom_1466154433105 row-o-full-height row-o-columns-stretch row-o-equal-height">
						...
						<div class="wpb_column vc_column_container column-4_12 vc_col-has-fill">
							<div class="vc_column-inner vc_custom_1466756857898">
								<div class="wpb_wrapper">
									<a id="sc_anchor_contacto" class="sc_anchor" title="Contacto" data-icon="" data-url=""></a>
									...
									<div class="sc_promo sc_promo_default sc_promo_size_normal sc_promo_no_paddings sc_promo_no_image">
										<div class="sc_promo_text sc_float_center" style="width: 100%;">
											<div class="sc_promo_text_inner sc_align_center" style="color: white !important;">
												...
												<h2 class="sc_item_title sc_promo_title" style="color: white !important;">Contacto</h2>
												<h5 class="sc_item_subtitle sc_promo_subtitle" style="color: white !important;">Contáctanos por algunos de los medios.</h5>
												<div class="sc_promo_content sc_item_content">
													<div class="wpb_text_column wpb_content_element ">
														<div class="wpb_wrapper">
															<p><em><strong style="color: white !important;">Dirección:</strong></em><br/> Ricardo Linares 107 Col. Centro, 62000 Cuernavaca</p>
															<p><em><strong style="color: white !important;">Teléfono:</strong></em><br/> +52 777 362 00 00</p>
															<p><em><strong style="color: white !important;">Correo Electrónico:</strong></em><br/> info@cervezapava.com</p>
														</div>
													</div>
												</div>
												<div class="sc_form sc_form_default sc_align_center">
													...
													<form class="sc_form_form sc_input_hover_underline" action="{{route('contact.store')}}" method="post">
													@csrf
														...
														<div class="sc_form_details trx_addons_columns_wrap">
															<div class="trx_addons_column-1_2">
																...
																<span class="sc_form_field_wrap"><input type="text" name="name" id="name" ><span class="sc_form_field_hover"><span class="sc_form_field_content" data-content="Name">Nombre</span></span></span>
															</label>
															@error('name')
															<div class="alert">
															...
															<div class="trx_addons_column-1_2">
																...
																<span class="sc_form_field_wrap"><input type="text" name="email" id="email" ><span class="sc_form_field_hover"><span class="sc_form_field_content" data-content="E-mail">E-mail</span></span></span>
															</label>
															@error('email')
															<div class="alert">
																<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
															...
															@enderror
																<label class="sc_form_field sc_form_field_email required">
																<span class="sc_form_field_wrap"><input type="text" name="phone" id="phone" ><span class="sc_form_field_hover"><span class="sc_form_field_content" data-content="Phone">Teléfono</span></span></span>
														...
														<label class="sc_form_field sc_form_field_message required"><span class="sc_form_field_wrap"><textarea id="message" name="message" ></textarea><span class="sc_form_field_hover"><span class="sc_form_field_content" data-content="Message">Mensaje</span></span>	</span>
														</label>
														@error('message')
														<div class="alert">
															<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
														...
														@error('g-recaptcha-response')
															<div class="alert">
																<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
																<strong>La validación de captcha es obligatoria.</strong>
															</div>
														@enderror
														</div>
														<div class="sc_form_field sc_form_field_button"><button type="submit">Envíar</button></div>
					...
					<div class="row wpb_row row-fluid" id="footer_menu"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1466156080949"><div class="wpb_wrapper"><a id="sc_anchor_footer" class="sc_anchor" title="Footer" data-icon="" data-url=""></a></div></div></div></div>
				</div>
				</article>
			</div>
		</div>
	...
	<footer class="site_footer_wrap scheme_dark">
		<div class="logo_footer_wrap scheme_dark">
			<div class="logo_footer_wrap_inner">
				<a href="index.html"><img src="images/pava/logo_footer.png" id="logofooter" class="logo_footer_image" width="200px" alt="" /></a>
			</div>
		</div>
			...
			<div class="menu_footer_wrap_inner">
				<nav class="menu_footer_nav_area">
					<ul id="menu_footer" class="menu_footer_nav">
						<li class="menu-item menu-item-143"><a href="#sc_anchor_inicio"><span>Inicio</span></a></li>
						<li class="menu-item menu-item-677"><a href="#sc_anchor_origen"><span>Origen</span></a></li>
						<li class="menu-item menu-item-675"><a href="#sc_anchor_caracteristicas"><span>Características</span></a></li>
						<li class="menu-item menu-item-676"><a href="#sc_anchor_contacto"><span>Contacto</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
		<div class="copyright_wrap scheme_dark">
			<div class="copyright_wrap_inner">
				<div class="content_wrap">
					<div class="copyright_text">© 2022 Cerveza Pava. Todos los derechos reservados   |   Developed By Desarrollo Web Las Mañanitas.</div>
				</div>
			</div>
		</div>
	</footer>
